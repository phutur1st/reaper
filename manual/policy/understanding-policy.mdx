...
**Caps limit a run; grace can delay deletion.** In [Pace and limits](/policy/understanding-policy#pace), enable **Wait for grace before deleting** to hold titles until their countdowns end. Otherwise, grace is notice-only. Review shows remaining time and exact deadlines. Watch or spare a title to keep it. Every deletion needs your approval.
